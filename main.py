...
def title_filter(dir_name: str, release_title_lst=[]):  # cwd, e.g: C:/Users/username/Downloads/foo.2021.1080p.WEB.H264-bar
...
def search_subscene(name_of_release: str):
...
search_subscene(title_filter(current_working_dir()))
