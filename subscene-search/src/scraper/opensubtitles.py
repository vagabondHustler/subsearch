...
from src.scraper.opensubtitles_soup import search_for_title
from src.scraper.opensubtitles_soup import search_title_for_sub
from src.scraper.opensubtitles_soup import get_download_url
...
def scrape(parameters, language: str, lang_abbr: str, hearing_impaired: str, precentage) -> list or None:
    # search for titles
    to_be_scraped: list = []
    title_keys = search_for_title(parameters.url_opensubtitles)
