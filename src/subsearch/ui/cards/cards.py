...
BUG_REPORT_BUTTON_ICON_SIZE = 24
BUG_REPORT_BUTTON_SIZE = 32
BUG_REPORT_ICON_SPACING = 48
...
class BugReportCard(SettingsCard):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        content_row.setSpacing(BUG_REPORT_ICON_SPACING)
        content_row.addStretch(1)
        content_row.addWidget(self._build_labelled_action(LucideIcon.BUG, "Report bug", _open_bug_report))
        content_row.addWidget(self._build_labelled_action(LucideIcon.FOLDER_SEARCH, "Open log location", _open_log_directory))
        content_row.addWidget(self._build_labelled_action(LucideIcon.SCROLL_TEXT, "View licenses", _open_third_party_licenses))
        content_row.addStretch(1)
    ...
    def _build_labelled_action(self, icon: LucideIcon, caption: str, on_click: Callable[[], None]) -> QWidget:
        ...
        button.setFixedSize(BUG_REPORT_BUTTON_SIZE, BUG_REPORT_BUTTON_SIZE)
        button.setIconSize(QSize(BUG_REPORT_BUTTON_ICON_SIZE, BUG_REPORT_BUTTON_ICON_SIZE))
